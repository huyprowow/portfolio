  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className='fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900'
        style={{ zIndex: 100000 }}
      >
        <div className='relative w-full max-w-md px-6'>
          ...
          <motion.div
            ...
            className='relative h-2 bg-slate-700 rounded-full overflow-hidden mb-6'
          >
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: `${progress}%` }}
              transition={{ duration: 0.5, ease: 'easeOut' }}
              className='h-full bg-gradient-to-r from-gray-500 to-white-500 rounded-full'
            />
          </motion.div>
